  ...
  return (
    <div className="min-h-screen relative flex flex-col items-center justify-center">
      ...
      <header className="absolute top-0 w-full z-10 flex items-center justify-between px-8 md:px-16 py-8">
        <WayneLogo src="/logo transparente.png" className="h-8 w-8 opacity-80" />

        <nav className="flex items-center gap-1 border border-white/10 bg-black/50 backdrop-blur-md px-2 py-1.5">
          {user ? (
            <Link
              href="/dashboard"
              className="font-sans text-sm text-white/80 hover:text-white hover:bg-white/10 transition-colors px-5 py-1.5"
            >
              Ir para o Painel
            </Link>
          ) : (
            <>
              <Link
                href="/auth/login"
                className="font-sans text-sm text-white/60 hover:text-white hover:bg-white/8 transition-colors px-5 py-1.5"
              >
                Login
              </Link>
              ...
              <Link
                href="/auth/sign-up"
                className="font-sans text-sm text-white/60 hover:bg-white/20 transition-colors px-5 py-1.5"
              >
                Cadastro
              </Link>
            </>
